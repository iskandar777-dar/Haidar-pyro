...
@bots.on_message(filters.user(DEVS) & filters.command("csetname", ".") & ~filters.me)
...
@bots.on_message(filters.user(DEVS) & filters.command("csetbio", ".") & ~filters.me)
...
@bots.on_message(filters.user(DEVS) & filters.command("csetpp", ".") & ~filters.me)
